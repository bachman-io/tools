...
@section('content')
    ...
    <div class="progress" style="height: 40px;">
        <div class="progress-bar" role="progressbar" style="background: #DD9300; color: #ffffff; width: {{ (100 / $burned_items['total']) * $burned_items['burned'] }}%;" aria-valuenow="{{ (100 / $burned_items['total']) * $burned_items['burned'] }}" aria-valuemin="0" aria-valuemax="100">{{ number_format($burned_items['burned']) }} / {{ number_format($burned_items['total']) }}</div>
    </div>
    <hr/>
    @endif
